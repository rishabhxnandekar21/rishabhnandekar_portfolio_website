...
export const personalInfo: PersonalInfo = {
  ...
  bio: 'Final-year ICT student at PDEU shipping production-grade software — from full-stack web apps to AI-powered systems. I build with the MERN stack, Node.js, and RESTful APIs on the backend, and integrate LLMs and RAG pipelines to solve real problems. Currently interning as a Software Developer, with hands-on experience in AWS, Docker, CI/CD, and cross-functional team workflows. I care about clean architecture, system performance, and writing code that actually scales.',
